export const translations = {
  en: {
    ...
    // Alerts Module
    alertTabAll: "All Alerts",
    alertTabActive: "Active",
    alertTabResolved: "Resolved",
    alertTabRules: "Alert Rules",
    alertTabEscalation: "Escalation",
    alertTabChannels: "Channels",
    alertTabAnalytics: "Analytics",
    alertTabTemplates: "Templates",
    alertFilters: "Filters",
    alertExportCSV: "Export CSV",
    ...
    alertLow: "Low",
    alertStatus: "Status",
    alertAllStatuses: "All Statuses",
    alertStatusActive: "Active",
    alertStatusAcknowledged: "Acknowledged",
    alertStatusResolved: "Resolved",
    alertStatusSuppressed: "Suppressed",
    alertNoResults: "No alerts match the current filters",
    alertId: "Alert ID",
    alertTriggerCondition: "Trigger Condition",
    alertStartTime: "Start Time",
    alertDuration: "Duration",
    alertAssignedTo: "Assigned To",
    alertAcknowledge: "Acknowledge",
    alertRulesCount: "rules configured",
    alertCreateRule: "Create Rule",
    alertRuleName: "Rule Name",
    alertRuleType: "Rule Type",
    alertTriggerCount: "Triggers",
    alertRuleScope: "Scope",
    alertEnterRuleName: "Enter rule name",
    alertRuleDescription: "Description",
    alertEnterRuleDescription: "Describe the alert rule",
    alertTypeThreshold: "Threshold",
    alertTypeCondition: "Condition",
    alertTypeTimeWindow: "Time Window",
    alertTypeDeviceState: "Device State",
    alertTypeHeartbeat: "Heartbeat",
    alertTypeAnomaly: "AI Anomaly",
    alertTypeCrossDevice: "Cross-Device",
    alertScopeDevices: "Devices",
    alertScopeDeviceType: "Device Type",
    alertScopeLocation: "Location",
    alertSelectDeviceType: "Select device type",
    alertSelectLocation: "Select location",
    alertConditionBuilderDesc: "Define trigger conditions using IF/AND/OR logic blocks",
    alertConditionGroupLabel: "Condition Group",
    alertTelemetryTag: "Telemetry Tag",
    alertSelectTag: "Select tag",
    alertOperator: "Operator",
    alertValue: "Value",
    alertValueTo: "Value To",
    alertTimeWindow: "Time Window",
    alertMinutes: "minutes",
    alertAddCondition: "Add Condition",
    alertAddConditionGroup: "Add OR Group",
    alertSelectSeverity: "Select alert severity level",
    alertSeverityCriticalDesc: "Immediate action required. System or safety critical.",
    alertSeverityHighDesc: "Urgent attention needed. Potential equipment damage.",
    alertSeverityMediumDesc: "Should be investigated. Operational deviation.",
    alertSeverityLowDesc: "Informational. Monitor for trends.",
    alertSelectEscalation: "Select escalation policy",
    alertImmediate: "Immediate",
    alertSelectChannels: "Select notification channels",
    alertAssignTeam: "Assign Responsible Team",
    alertSelectTeam: "Select team",
    alertTeamOperations: "Operations",
    alertTeamMaintenance: "Maintenance",
    alertTeamManagement: "Management",
    alertTeamSafety: "Safety",
    alertRuleSummary: "Rule Summary",
    alertChannelsSelected: "channels selected",
    alertStepScope: "Scope",
    alertStepConditions: "Conditions",
    alertStepSeverity: "Severity",
    alertStepEscalation: "Escalation",
    alertStepNotifications: "Notifications",
    alertStepAssignment: "Assignment",
    alertTotalAlerts: "Total Alerts",
    alertMTTA: "MTTA",
    alertMTTR: "MTTR",
    alertCriticalCount: "Critical Alerts",
    alertsOverTime: "Alerts Over Time",
    alertBySeverity: "By Severity",
    alertByLocation: "By Location",
    alertTopDevices: "Most Problematic Devices",
    alertEscalationPoliciesCount: "escalation policies",
    alertCreateEscalation: "Create Policy",
    alertChannelsCount: "notification channels",
    alertAddChannel: "Add Channel",
    alertChannelType: "Type",
    alertChannelConfig: "Configuration",
    alertTemplatesDesc: "Pre-configured alert rule templates for common industrial scenarios",
    alertCreateTemplate: "Create Template",
    alertUseTemplate: "Use This Template",
  },
  ar: {
    // Hero Section
    ...
    // Alerts Module
    alertTabAll: "جميع التنبيهات",
    alertTabActive: "نشطة",
    alertTabResolved: "محلولة",
    alertTabRules: "قواعد التنبيه",
    alertTabEscalation: "التصعيد",
    alertTabChannels: "القنوات",
    alertTabAnalytics: "التحليلات",
    alertTabTemplates: "القوالب",
    alertFilters: "فلاتر",
    alertExportCSV: "تصدير CSV",
    alertSeverity: "الخطورة",
    alertAllSeverities: "جميع المستويات",
    alertCritical: "حرج",
    alertHigh: "عالي",
    alertMedium: "متوسط",
    alertLow: "منخفض",
    alertStatus: "الحالة",
    alertAllStatuses: "جميع الحالات",
    alertStatusActive: "نشط",
    alertStatusAcknowledged: "تم الاستلام",
    alertStatusResolved: "تم الحل",
    alertStatusSuppressed: "مكتوم",
    alertNoResults: "لا توجد تنبيهات تطابق الفلاتر الحالية",
    alertId: "معرف التنبيه",
    alertTriggerCondition: "شرط التفعيل",
    alertStartTime: "وقت البدء",
    alertDuration: "المدة",
    alertAssignedTo: "مسند إلى",
    alertAcknowledge: "تأكيد الاستلام",
    alertRulesCount: "قواعد مهيأة",
    alertCreateRule: "إنشاء قاعدة",
    alertRuleName: "اسم القاعدة",
    alertRuleType: "نوع القاعدة",
    alertTriggerCount: "عدد التفعيلات",
    alertRuleScope: "النطاق",
    alertEnterRuleName: "أدخل اسم القاعدة",
    alertRuleDescription: "الوصف",
    alertEnterRuleDescription: "صف قاعدة التنبيه",
    alertTypeThreshold: "عتبة",
    alertTypeCondition: "شرط",
    alertTypeTimeWindow: "نافذة زمنية",
    alertTypeDeviceState: "حالة الجهاز",
    alertTypeHeartbeat: "نبض القلب",
    alertTypeAnomaly: "شذوذ AI",
    alertTypeCrossDevice: "متعدد الأجهزة",
    alertScopeDevices: "الأجهزة",
    alertScopeDeviceType: "نوع الجهاز",
    alertScopeLocation: "الموقع",
    alertSelectDeviceType: "اختر نوع الجهاز",
    alertSelectLocation: "اختر الموقع",
    alertConditionBuilderDesc: "حدد شروط التفعيل باستخدام منطق IF/AND/OR",
    alertConditionGroupLabel: "مجموعة الشروط",
    alertTelemetryTag: "علامة القياس",
    alertSelectTag: "اختر العلامة",
    alertOperator: "العامل",
    alertValue: "القيمة",
    alertValueTo: "القيمة إلى",
    alertTimeWindow: "النافذة الزمنية",
    alertMinutes: "دقائق",
    alertAddCondition: "إضافة شرط",
    alertAddConditionGroup: "إضافة مجموعة OR",
    alertSelectSeverity: "اختر مستوى خطورة التنبيه",
    alertSeverityCriticalDesc: "يتطلب إجراء فوري. حرج للنظام أو السلامة.",
    alertSeverityHighDesc: "يحتاج اهتمام عاجل. احتمال تلف المعدات.",
    alertSeverityMediumDesc: "يجب التحقيق. انحراف تشغيلي.",
    alertSeverityLowDesc: "معلوماتي. مراقبة الاتجاهات.",
    alertSelectEscalation: "اختر سياسة التصعيد",
    alertImmediate: "فوري",
    alertSelectChannels: "اختر قنوات الإشعار",
    alertAssignTeam: "تعيين الفريق المسؤول",
    alertSelectTeam: "اختر الفريق",
    alertTeamOperations: "العمليات",
    alertTeamMaintenance: "الصيانة",
    alertTeamManagement: "الإدارة",
    alertTeamSafety: "السلامة",
    alertRuleSummary: "ملخص القاعدة",
    alertChannelsSelected: "قنوات محددة",
    alertStepScope: "النطاق",
    alertStepConditions: "الشروط",
    alertStepSeverity: "الخطورة",
    alertStepEscalation: "التصعيد",
    alertStepNotifications: "الإشعارات",
    alertStepAssignment: "التعيين",
    alertTotalAlerts: "إجمالي التنبيهات",
    alertMTTA: "متوسط وقت الاستلام",
    alertMTTR: "متوسط وقت الحل",
    alertCriticalCount: "التنبيهات الحرجة",
    alertsOverTime: "التنبيهات عبر الزمن",
    alertBySeverity: "حسب الخطورة",
    alertByLocation: "حسب الموقع",
    alertTopDevices: "الأجهزة الأكثر إشكالية",
    alertEscalationPoliciesCount: "سياسات تصعيد",
    alertCreateEscalation: "إنشاء سياسة",
    alertChannelsCount: "قنوات إشعار",
    alertAddChannel: "إضافة قناة",
    alertChannelType: "النوع",
    alertChannelConfig: "الإعدادات",
    alertTemplatesDesc: "قوالب قواعد تنبيه مهيأة مسبقاً للسيناريوهات الصناعية الشائعة",
    alertCreateTemplate: "إنشاء قالب",
    alertUseTemplate: "استخدم هذا القالب",
  },
  fa: {
    // Hero Section
    ...
    // Alerts Module
    alertTabAll: "همه هشدارها",
    alertTabActive: "فعال",
    alertTabResolved: "حل شده",
    alertTabRules: "قوانین هشدار",
    alertTabEscalation: "تشدید",
    alertTabChannels: "کانال‌ها",
    alertTabAnalytics: "تحلیل‌ها",
    alertTabTemplates: "قالب‌ها",
    alertFilters: "فیلترها",
    alertExportCSV: "خروجی CSV",
    alertSeverity: "شدت",
    alertAllSeverities: "همه سطوح",
    alertCritical: "بحرانی",
    alertHigh: "بالا",
    alertMedium: "متوسط",
    alertLow: "کم",
    alertStatus: "وضعیت",
    alertAllStatuses: "همه وضعیت‌ها",
    alertStatusActive: "فعال",
    alertStatusAcknowledged: "تأیید شده",
    alertStatusResolved: "حل شده",
    alertStatusSuppressed: "سرکوب شده",
    alertNoResults: "هشداری با فیلترهای فعلی مطابقت ندارد",
    alertId: "شناسه هشدار",
    alertTriggerCondition: "شرط فعال‌سازی",
    alertStartTime: "زمان شروع",
    alertDuration: "مدت",
    alertAssignedTo: "واگذار به",
    alertAcknowledge: "تأیید دریافت",
    alertRulesCount: "قانون پیکربندی شده",
    alertCreateRule: "ایجاد قانون",
    alertRuleName: "نام قانون",
    alertRuleType: "نوع قانون",
    alertTriggerCount: "تعداد فعال‌سازی",
    alertRuleScope: "محدوده",
    alertEnterRuleName: "نام قانون را وارد کنید",
    alertRuleDescription: "توضیحات",
    alertEnterRuleDescription: "قانون هشدار را شرح دهید",
    alertTypeThreshold: "آستانه",
    alertTypeCondition: "شرط",
    alertTypeTimeWindow: "پنجره زمانی",
    alertTypeDeviceState: "وضعیت دستگاه",
    alertTypeHeartbeat: "ضربان قلب",
    alertTypeAnomaly: "آنومالی AI",
    alertTypeCrossDevice: "چند دستگاه",
    alertScopeDevices: "دستگاه‌ها",
    alertScopeDeviceType: "نوع دستگاه",
    alertScopeLocation: "مکان",
    alertSelectDeviceType: "نوع دستگاه را انتخاب کنید",
    alertSelectLocation: "مکان را انتخاب کنید",
    alertConditionBuilderDesc: "شرایط فعال‌سازی را با منطق IF/AND/OR تعریف کنید",
    alertConditionGroupLabel: "گروه شروط",
    alertTelemetryTag: "تگ تله‌متری",
    alertSelectTag: "تگ را انتخاب کنید",
    alertOperator: "عملگر",
    alertValue: "مقدار",
    alertValueTo: "مقدار تا",
    alertTimeWindow: "پنجره زمانی",
    alertMinutes: "دقیقه",
    alertAddCondition: "افزودن شرط",
    alertAddConditionGroup: "افزودن گروه OR",
    alertSelectSeverity: "سطح شدت هشدار را انتخاب کنید",
    alertSeverityCriticalDesc: "نیاز به اقدام فوری. بحرانی برای سیستم یا ایمنی.",
    alertSeverityHighDesc: "نیاز به توجه فوری. احتمال آسیب تجهیزات.",
    alertSeverityMediumDesc: "باید بررسی شود. انحراف عملیاتی.",
    alertSeverityLowDesc: "اطلاعاتی. نظارت بر روندها.",
    alertSelectEscalation: "سیاست تشدید را انتخاب کنید",
    alertImmediate: "فوری",
    alertSelectChannels: "کانال‌های اطلاع‌رسانی را انتخاب کنید",
    alertAssignTeam: "تعیین تیم مسئول",
    alertSelectTeam: "تیم را انتخاب کنید",
    alertTeamOperations: "عملیات",
    alertTeamMaintenance: "تعمیر و نگهداری",
    alertTeamManagement: "مدیریت",
    alertTeamSafety: "ایمنی",
    alertRuleSummary: "خلاصه قانون",
    alertChannelsSelected: "کانال انتخاب شده",
    alertStepScope: "محدوده",
    alertStepConditions: "شرایط",
    alertStepSeverity: "شدت",
    alertStepEscalation: "تشدید",
    alertStepNotifications: "اطلاع‌رسانی",
    alertStepAssignment: "واگذاری",
    alertTotalAlerts: "کل هشدارها",
    alertMTTA: "میانگین زمان تأیید",
    alertMTTR: "میانگین زمان حل",
    alertCriticalCount: "هشدارهای بحرانی",
    alertsOverTime: "هشدارها در طول زمان",
    alertBySeverity: "بر اساس شدت",
    alertByLocation: "بر اساس مکان",
    alertTopDevices: "پرمشکل‌ترین دستگاه‌ها",
    alertEscalationPoliciesCount: "سیاست تشدید",
    alertCreateEscalation: "ایجاد سیاست",
    alertChannelsCount: "کانال اطلاع‌رسانی",
    alertAddChannel: "افزودن کانال",
    alertChannelType: "نوع",
    alertChannelConfig: "پیکربندی",
    alertTemplatesDesc: "قالب‌های از پیش تنظیم‌شده قوانین هشدار برای سناریوهای رایج صنعتی",
    alertCreateTemplate: "ایجاد قالب",
    alertUseTemplate: "استفاده از این قالب",
  },
};
