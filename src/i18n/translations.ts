export const translations = {
  ...
  fa: {
    ...
    iotCloudPlatformNavDesc: "پلتفرم جامع مدیریت اینترنت اشیا",
    ota: "به‌روزرسانی از راه دور",
    otaNavDesc: "به‌روزرسانی‌های فریمور از راه دور",
    intelligenceInsight: "تحلیل‌های هوشمند",
    intelligenceInsightNavDesc: "تحلیل و بینش مبتنی بر هوش مصنوعی",
