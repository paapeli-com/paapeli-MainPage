export const translations = {
  ...
  fa: {
    ...
    iotCloudPlatformNavDesc: "پلتفرم مدیریت کامل اینترنت اشیا",
    ota: "OTA",
    otaNavDesc: "به‌روزرسانی‌های فریم‌ور از راه دور",
    intelligenceInsight: "بینش هوشمند",
    intelligenceInsightNavDesc: "تحلیل‌ها و بینش‌های مبتنی بر هوش مصنوعی",
