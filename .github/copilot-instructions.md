...
You are assisting with the Paapeli IoT Platform codebase. Follow these guidelines:
...
3. Update both `.claude/instructions.md` and `.github/copilot-instructions.md`
4. Test changes
