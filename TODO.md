...
- [x] Implement device status endpoint for OTA updates
...
- [x] Add stages configuration for OTA campaigns
...
- [x] Implement alerts API for dashboard
...
- [x] Fix React Router future flag warnings in tests (2026-01-10)